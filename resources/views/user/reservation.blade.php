...
@extends('head.user')
@section('content')
<center> <h2> Vos RéservationSSSS </h2> </center>
<br>
@if ($dbreserv[0] == 0)
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="annuler" method="post">
                                ...
                                @if ($annule == 0)
                                    <button type="submit" value={{$reservdata -> idReservation}} onclick='return confirm("Êtes-vous sûr de vouloir annuler la reservation ?")' name="id" class="btn btn-danger">Annuler</button>
                                @else
                                    <button type="submit" value={{$reservdata -> idReservation}} onclick='return confirm("Êtes-vous sûr de vouloir annuler la reservation ?")' name="id" class="btn btn-danger" disabled>Annuler</button>
                                @endif
                            </form>
                        </td>
                    </tr>
