...
class admin extends Controller
{
    ...
    {
        $listeHistoReservation = reservation::join('utilisateurs','reservations.utilisateur','=','idUtilisateur')->join('parkings', 'reservations.numeroPlace', '=', 'idParking')->select('idReservation','positionFileAttente','parkings.numeroPlace AS numeroPlace','etatReservation','dateDebut','dateFin','nomUtilisateur')->orderBy('idReservation', 'desc')->get();
